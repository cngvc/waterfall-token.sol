...
contract Waterfall is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _maxTxAmount = 500000000 * 10**12;
    ...
    uint256 private _previousFee = taxFee;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tFee = tAmount.div(10**2).mul(taxFee);
